		...
		<?php
			if(isset($_POST['edit_user_details'])){
				...
				if($edit_img && $edit_role){
					...
					$query_update_user = "UPDATE users SET username = '{$edit_username}',  firstname = '{$edit_fname}',  lastname = '{$edit_lname}',  email = '{$edit_mail}',  user_img = '{$edit_img}',  password = '{$edit_pass}', Role = '{$u_role}' WHERE user_id = '$edUser_id' ";
